<template>
    <div>
        ...
        <div class="results">
            <div class="panel panel-default" v-for="support_staff in searchResults">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-1">
                            <img :src="'/'+support_staff.photo_url" alt="Photo" class="img-thumbnail img-responsive">
                        </div>
                        <div class="col-sm-4">
                            <a :href="'/'+resource+'/'+support-staff.id+'/edit'">
                                <h4>{{ support_staff.first_name }} {{ support_staff.middle_name }} {{ support_staff.last_name }}</h4>
                            </a>
